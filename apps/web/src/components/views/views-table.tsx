      ...
      <div className="min-w-[700px]">
        ...
        <div className="sticky top-0 z-10 bg-background border-b border-border/60 flex items-center gap-0 text-xs font-medium text-muted-foreground">
          <button
            ...
            className="flex items-center px-4 py-2.5 flex-1 min-w-[180px] hover:text-foreground transition-colors text-left"
          >
            Work Items
        ...
        {tasks.map((task) => (
          ...
          >
            {/* Work Item */}
            <div className="flex items-center gap-2 px-4 py-2.5 flex-1 min-w-[180px]">
